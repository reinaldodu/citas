<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="box">    
                       ...
                       <!--Citas agendadas
                      <h1 class="text-xl font-bold ml-4 mb-5"  style="color:#091a32;">
                              Citas agendadas
                      </h1>  
                  
                      <div class="flex flex-col stats shadow text-white w-[1170px] bg-[#040c1e]">
                        
                      <div class="grow-0">
                          <div class="stat">
                              <div class="stat-figure text-secondary">
                              <a href="{{route('historial.reporte', ['tipo' => 'agendadas_ttl'])}}" class="btn btn-xs btn-success">Ver</a>
                          ...
                          <div class="stat">
                              <div class="stat-figure text-secondary">
                              <a href="{{route('historial.reporte', ['tipo' => 'agendadas_dia'])}}" class="btn btn-xs btn-success">Ver</a>
                          ...
                          <div class="stat">
                              <div class="stat-figure text-secondary">
                              <a href="{{route('historial.reporte', ['tipo' => 'agendadas_semana'])}}" class="btn btn-xs btn-success">Ver</a>
                          ...
                          <div class="stat">
                              <div class="stat-figure text-secondary">
                              <a href="{{route('historial.reporte', ['tipo' => 'agendadas_mes'])}}" class="btn btn-xs btn-success">Ver</a>
                          </div>
                    ...
                    <div class="flex flex-col  ">
                        ...
                        <div class="stats shadow-xl mb-10 bg-blue-200">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="stats shadow-xl mb-10 bg-yellow-200">
                       
                        <div class="stat">
                              <div class="stat-figure text-secondary">
                              <a href="{{route('historial.reporte', ['tipo' => 'atendidas_ttl'])}}" class="btn btn-xs btn-success">Ver</a>
                        ...
                        <div class="stat">
                              <div class="stat-figure text-secondary">
                              <!--<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-8 h-8 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>-->
                              <a href="{{route('historial.reporte', ['tipo' => 'atendidas_dia'])}}" class="btn btn-xs btn-success">Ver</a>
                          ...
                          <div class="stat">
                              <div class="stat-figure text-secondary">
                              <!--<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-8 h-8 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path></svg>-->
                              <a href="{{route('historial.reporte', ['tipo' => 'atendidas_semana'])}}" class="btn btn-xs btn-success">Ver</a>
                          ...
                          <div class="stat">
                              <div class="stat-figure text-secondary">
                              <!--<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-8 h-8 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"></path></svg>-->
                              <a href="{{route('historial.reporte', ['tipo' => 'atendidas_mes'])}}" class="btn btn-xs btn-success">Ver</a>
                          </div>
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="stats shadow-xl mb-10 bg-gray-200">
                       
                        <div class="stat">
                              <div class="stat-figure text-secondary">
                              <!--<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-8 h-8 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>-->
                              <a href="{{route('historial.reporte', ['tipo' => 'canceladas_ttl'])}}" class="btn btn-xs btn-success">Ver</a>
  
                          </div>
                              <div class="stat-title">Total citas canceladas</div>
                        ...
                        <div class="stat">
                              <div class="stat-figure text-secondary">
                              <!--<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-8 h-8 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>-->
                              <a href="{{route('historial.reporte', ['tipo' => 'canceladas_dia'])}}" class="btn btn-xs btn-success">Ver</a>
                          ...
                          <div class="stat">
                              <div class="stat-figure text-secondary">
                              <!--<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-8 h-8 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path></svg>-->
                              <a href="{{route('historial.reporte', ['tipo' => 'canceladas_semana'])}}" class="btn btn-xs btn-success">Ver</a>
                          ...
                          <div class="stat">
                              <div class="stat-figure text-secondary">
                              <!--<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-8 h-8 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"></path></svg>-->
                              <a href="{{route('historial.reporte', ['tipo' => 'canceladas_mes'])}}" class="btn btn-xs btn-success">Ver</a>
                          </div>
  ...
  <!----------------------------------------------------------------->
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="stats shadow-xl mb-10 bg-green-200 ">
                       
                        <div class="stat">
                              <div class="stat-figure text-secondary">
                              <!--<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-8 h-8 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>-->
                              <a href="{{route('historial.reporte', ['tipo' => 'procedimientos_ttl'])}}" class="btn btn-xs btn-success">Ver</a>
                        ...
                        <div class="stat">
                              <div class="stat-figure text-secondary">
                              <!--<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-8 h-8 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>-->
                              <a href="{{route('historial.reporte', ['tipo' => 'procedimientos_dia'])}}" class="btn btn-xs btn-success">Ver</a>
                          ...
                          <div class="stat">
                              <div class="stat-figure text-secondary">
                              <!--<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-8 h-8 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path></svg>-->
                              <a href="{{route('historial.reporte', ['tipo' => 'procedimientos_semana'])}}" class="btn btn-xs btn-success">Ver</a>
                          ...
                          <div class="stat">
                              <div class="stat-figure text-secondary">
                              <!--<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-8 h-8 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"></path></svg>-->
                              <a href="{{route('historial.reporte', ['tipo' => 'procedimientos_mes'])}}" class="btn btn-xs btn-success">Ver</a>
                          </div>
          ...
          <!--Citas atendidas-->
            <!--
                <div class="box">
                        <h1 class="text-xl font-bold ml-10 mt-5 " style="color:#091a32;">
                                Citas atendidas
                        </h1>  
                        ...
                        <div class="stats shadow ml-5 mt-5" style="color:white; width:1170px; background-color:#091a32;">
                            ...
                            <div class="stat">
                                <div class="stat-figure text-secondary">
                            <a href="{{route('historial.reporte', ['tipo' => 'atendidas_ttl'])}}" class="btn btn-xs btn-color">Ver</a>
                            ...
                            <div class="stat">
                                <div class="stat-figure text-secondary">
                            <a href="{{route('historial.reporte', ['tipo' => 'atendidas_dia'])}}" class="btn btn-xs btn-color">Ver</a>
                            </div>
                                <div class="stat-title">Citas atendidas del día</div>
                                <div class="stat-value">{{$citas_atendidas['citas_atendidas_dia']}}</div>
                                <div class="stat-desc">{{\Carbon\Carbon::now()->format('d-m-Y')}}</div>
                            ...
                            <div class="stat">
                                <div class="stat-figure text-secondary">
                                <a href="{{route('historial.reporte', ['tipo' => 'atendidas_semana'])}}" class="btn btn-xs btn-color">Ver</a>
                            </div>
                                <div class="stat-title">Citas atendidas de la semana</div>
                                <div class="stat-value">{{$citas_atendidas['citas_atendidas_semana']}}</div>
                                <div class="stat-desc">{{\Carbon\Carbon::now()->startOfWeek()->format('d-m-Y')}} al {{\Carbon\Carbon::now()->endOfWeek()->format('d-m-Y')}}</div>
                            ...
                            <div class="stat">
                                <div class="stat-figure text-secondary">
                                <a href="{{route('historial.reporte', ['tipo' => 'atendidas_mes'])}}" class="btn btn-xs btn-color">Ver</a>
                    ...
                    <div class="box">                  
                        ...
                        <div class="stats shadow ml-5 mt-5 bg-primary" style="color:white; width:1170px; background-color:#496063;">
                            ...
                            <div class="stat">
                                <div class="stat-figure text-secondary">
                                <a href="{{route('historial.reporte', ['tipo' => 'procedimientos_ttl'])}}" class="btn btn-xs btn-color">Ver</a>
                            ...
                            <div class="stat">
                                <div class="stat-figure text-secondary">
                            <a href="{{route('historial.reporte', ['tipo' => 'procedimientos_dia'])}}" class="btn btn-xs btn-color">Ver</a>
                            </div>
                                <div class="stat-title">Procedimientos del día</div>
                                <div class="stat-value">{{$procedimientos['procedimientos_dia']}}</div>
                                <div class="stat-desc">{{\Carbon\Carbon::now()->format('d-m-Y')}}</div>
                            ...
                            <div class="stat">
                                <div class="stat-figure text-secondary">
                                <a href="{{route('historial.reporte', ['tipo' => 'procedimientos_semana'])}}" class="btn btn-xs btn-color">Ver</a>
                            ...
                            <div class="stat" >
                                <div class="stat-figure text-secondary">
                                <a href="{{route('historial.reporte', ['tipo' => 'procedimientos_mes'])}}" class="btn btn-xs btn-color">Ver</a>
