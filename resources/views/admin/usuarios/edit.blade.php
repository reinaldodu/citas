                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('usuarios.update', $user) }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="nombres" class="block mt-1 w-full" type="text" name="nombres" :value="old('nombres', $user->nombres)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="apellidos" class="block mt-1 w-full" type="text" name="apellidos" :value="old('apellidos', $user->apellidos)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="documento" class="block mt-1 w-full" type="text" name="documento" :value="old('documento', $user->documento)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="fecha_nacimiento" class="block mt-1 w-full" type="date" name="fecha_nacimiento" :value="old('fecha_nacimiento', $user->fecha_nacimiento)" required />
